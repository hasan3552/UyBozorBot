...
public interface DemoUtil {
    ...
    String KVARTIRA_UZ = "\uD83C\uDFE2 Kvartira";
    String KVARTIRA_RU = "\uD83C\uDFE2 Kвартира";

    String HOUSE_UZ = "\uD83C\uDFE1 Hovli";
    String HOUSE_RU = "\uD83C\uDFE1 Частный дом";

    String GROUND_UZ = "\uD83C\uDFD7 Yer uchastka";
    String GROUND_RU = "\uD83C\uDFD7 Плащатка";
    ...
    String SETTING_LANGUAGE_UZ = "\uD83C\uDF10 Tilni o'zgartirish";
    String SETTING_LANGUAGE_RU = "\uD83C\uDF10 Изменить язык";

    String SETTING_FULLNAME_UZ = "✏️ Foydalanuvchi nomi";
    String SETTING_FULLNAME_RU = "✏️ Имя пользователя";

    String SETTING_CALL_NUMBER_UZ = "\uD83D\uDCDE Telefon raqam";
    String SETTING_CALL_NUMBER_RU = "\uD83D\uDCDE Телефонный номер";

    String BACK_REPLY_UZ = "⬅️ ORQAGA";
    String BACK_REPLY_RU = "⬅️ НАЗАД";
}
